...
const navItems = [
  ...
  { path: '/incidents', label: 'Live Incidents', icon: AlertIcon },
  { path: '/map', label: 'Disaster Map', icon: MapIcon },
  { path: '/reports', label: 'Reports', icon: ReportIcon },
  { path: '/verification', label: 'Verification', icon: CheckIcon },
    ...
    <>
      ...
      <aside className={`sidebar ${open ? 'open' : ''}`}>
        <div className="sidebar-header">
          ...
          <div>
            <div className="sidebar-title">Disaster Intelligence</div>
            <div className="sidebar-subtitle">Real-Time Aggregation</div>
          </div>
        </div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-version">SIH 2026 · SIH26054</div>
        </div>
      </aside>
    </>
  )
